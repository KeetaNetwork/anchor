...
One body of knowledge takes one page as its home. A second page that needs it MUST link to that home rather than restate it. The overview names the audience of every other page.
