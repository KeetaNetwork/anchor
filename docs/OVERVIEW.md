...
| How does a writer review a page in this tree? | [Documentation Standard](README.md) |
...
| A documentation page | This tree, then the index on [Documentation Standard](README.md) |
