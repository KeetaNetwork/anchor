...
import type { SharedAnchorAcceptedIssuerDNsMetadata, SharedAnchorMetadataLegalExtension } from './metadata.types.js';
...
type ServiceMetadata = {
	...
	services: {
		...
		username?: {
			[id: string]: SharedAnchorAcceptedIssuerDNsMetadata & {
				operations: {
