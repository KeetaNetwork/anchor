...
import type { SharedAnchorAuthCertificateMetadata, SharedAnchorMetadataLegalExtension } from './metadata.types.js';
...
type ServiceMetadata = {
	...
	services: {
		...
		username?: {
			[id: string]: SharedAnchorAuthCertificateMetadata & {
				operations: {
